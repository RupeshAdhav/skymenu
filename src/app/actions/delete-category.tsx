...
import { deleteCategory, getUser } from '@/appwrite/appwrite-functions'
        ...
        try {
            ...
            .then(function(){
                ...
                .then(function(){
                    ...
                    toast.success('Category \"'+props.category.category_name+'\" deleted');
                ...
                <div className="modal-box rounded p-0">
                    ...
                    <div className="modal-action px-6">
                        <div className="w-full pb-6">
                            <p>Are you sure do you want to delete this category and all its items permanently?</p>
                        </div>
                    </div>
