        ...
        <>
            { (props.item.type === "veg" && props.itemType === "veg") 
                ...
                <>
                    ...
                    <div className="grid grid-cols-5 border-b-0 px-4 pt-3">
                        <div className="col-span-4 pb-0 text-left">
                            ...
                            {props.item.tag === "special" ? <>{" "}<a className="bg-yellow-500 text-white badge badge-xs cursor-none m-0">SPECIAL</a></> : ""}
                            {props.item.tag === "best seller" ? <>{" "}<a className="bg-red-500 text-white badge badge-xs cursor-none">BEST SELLER</a></> : ""}
                            {props.item.tag === "must try" ? <>{" "}<a className="bg-blue-500 text-white badge badge-xs cursor-none">MUST TRY</a></> : ""}
                        </div>
                    ...
                    <div className={`grid grid-cols-5 ${props.theme.border_size} ${props.theme.border_color} px-4 pb-3`}>
